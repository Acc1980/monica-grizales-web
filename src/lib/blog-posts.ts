...
export const blogPosts: BlogPost[] = [
  {
    slug: "3-bloqueos-que-te-impiden-ocupar-tu-lugar-como-mujer",
    title: "Los 3 bloqueos que te impiden ocupar tu lugar como mujer",
    excerpt:
...
Si algo de lo que leíste hoy te resonó, es porque algo en ti ya sabe que es tiempo.
  ...
  {
    slug: "la-desconexion-con-tu-madre-el-origen-de-todo",
    title: "La desconexión con tu madre: el origen que nadie te contó",
    excerpt:
...
Pregúntate:
- ¿Qué aprendí de mi mamá sobre ser mujer?
- ¿La pruebo o la rechazo internamente?
- ¿Qué parte de su historia estoy repitiendo sin darme cuenta?
...
Y si en algún punto sientes que quieres ir más profundo, eso es exactamente lo que trabajamos en **Reconociendo mi Poder**.
  ...
  {
    slug: "por-que-elegimos-desde-nuestras-heridas",
    title: "¿Por qué elegimos desde nuestras heridas (y cómo parar de hacerlo)?",
    excerpt:
