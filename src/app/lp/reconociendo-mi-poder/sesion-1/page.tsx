    ...
    >
      <div className="max-w-4xl mx-auto px-4 py-16 md:py-24">
        ...
        <div
          ...
          style={{ background: "rgba(124,92,191,0.08)", border: "1px solid rgba(124,92,191,0.15)" }}
        >
          <p className="text-sm mb-1" style={{ color: "rgba(245,240,255,0.6)" }}>
            ¿Tienes preguntas o necesitas apoyo?
          </p>
          <a
            href={WA_COMMUNITY}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 font-semibold text-sm mt-3 px-6 py-3 rounded-full transition-all hover:scale-105"
